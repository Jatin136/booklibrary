...
exports.bookinstance_delete_get = function(req, res, next) {
    ...
    .exec(function (err, bookinstance) {
        ...
        res.json( { title: 'Delete BookInstance', bookinstance:  bookinstance});
    });
...
exports.bookinstance_update_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        books: function(callback) {
            ...
            res.json({ title: 'Update  BookInstance', book_list : results.books, selected_book : results.bookinstance.book._id, bookinstance:results.bookinstance });
        });
        ...
        if (!errors.isEmpty()) {
            ...
            Book.find({},'title')
                .exec(function (err, books) {
                    ...
                    res.json('bookinstance_form', { title: 'Update BookInstance', book_list : books, selected_book : bookinstance.book._id , errors: errors.array(), bookinstance:bookinstance });
            });
            return;
        }
        else {
